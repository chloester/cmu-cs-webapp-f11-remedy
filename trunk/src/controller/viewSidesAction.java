 ...
 */
public class viewSidesAction extends Action1 {
	...
	public String getName() { return "showAddSide.do"; }
	...
	public String perform(HttpServletRequest request) {
		...
		SideEffects[] SideEffectsList = sideDAO.getSideEffectsList(user.getEmailAddress());
